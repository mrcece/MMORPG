...
////// Emissive:
                ...
                float node_5303 = 0.0;
                float3 emissive = (_Color.rgb*((node_2070*lerp((node_6241_if_leA*_SCS_var)+(node_6241_if_leB*1.0),_SCS_var,node_6241_if_leA*node_6241_if_leB))+(lerp((node_6071_if_leA*node_1109)+(node_6071_if_leB*1.0),node_1109,node_6071_if_leA*node_6071_if_leB)*((_SpB*_SpB*_Y_var.g)*lerp((node_9518_if_leA*node_2710)+(node_9518_if_leB*1.0),node_2710,node_9518_if_leA*node_9518_if_leB)))+lerp( 0.0, (lerp((node_6526_if_leA*node_4952)+(node_6526_if_leB*1.0),node_4952,node_6526_if_leA*node_6526_if_leB)*_Dissovle_Color.rgb*2.0), _DColor_Switch )+lerp( 0.0, (lerp((node_2948_if_leA*1.0)+(node_2948_if_leB*node_5303),node_5303,node_2948_if_leA*node_2948_if_leB)*_Fresnel_Color.rgb), _Fresnel_Switch )));
