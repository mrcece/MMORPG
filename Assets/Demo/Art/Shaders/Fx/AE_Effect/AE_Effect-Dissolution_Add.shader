...
Shader "AE_Effect/Dissolution_Add" {
    Properties {
...
////// Emissive:
                ...
                float3 emissive = ((_Color.rgb*_Brightness*_MainTex_var.rgb)*i.vertexColor.rgb);
                ...
                return fixed4(finalColor,(_Color.a*(_MainTex_var.a*(node_5746+node_1274))));
            }
            ENDCG
        }
    }
